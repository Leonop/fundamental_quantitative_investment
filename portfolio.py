...
from quants import weighted_mean, weighted_std, sharpe_ratio
from returns import historical_mean_return
from returns import daily_returns, cumulative_returns
from returns import daily_log_returns
from efficient_frontier import EfficientFrontier
from monte_carlo import MonteCarloOpt
...
def _wrds_request(path):
    """This function performs a simple request local csv files
    :Input:
...
def _build_portfolio_from_api(
    ...
    if data_api == "yfinance":
        ...
        data = _wrds_request(names, start_date, end_date)
    # check pf_allocation:
